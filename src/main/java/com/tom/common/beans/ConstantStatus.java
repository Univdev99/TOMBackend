...
public enum ConstantStatus {
	...
	UNAUTHORIZED(401), // Wrong Credentials (Ex. Username or Password is incorrect)

	FORBIDDEN(403), // Unauthorized/Forbidden (Ex. You are not authorized to view this page)
